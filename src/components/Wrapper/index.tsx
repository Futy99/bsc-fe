...
const Wrapper = (props: React.PropsWithChildren<IProps>) => {
  ...
  const handleClose = (closedByInsideClick: boolean = false, language: string = t('components.wrapper.en')) => {
        ...
        <ChangeLanguage>
          ...
          <Menu id="simple-menu" anchorEl={anchorEl} keepMounted open={Boolean(anchorEl)} onClose={handleClose}>
            <MenuItem onClick={() => handleClose(true, 'cs')}>
              <Typography color="textSecondary">{t('components.wrapper.cs')}</Typography>
            </MenuItem>
            <MenuItem onClick={() => handleClose(true, 'en')}>
              <Typography color="textSecondary">{t('components.wrapper.en')}</Typography>
            </MenuItem>
          </Menu>
        </ChangeLanguage>
      </TopBar>
