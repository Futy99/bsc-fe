...
function* getNote() {
  yield takeEvery(actions.Types.GET_NOTE, function* handle(
    action: ReturnType<typeof actions.getNote>,
  ) {
...
function* updateNote() {
  yield takeEvery(actions.Types.UPDATE_NOTE, function* handle(
    action: ReturnType<typeof actions.updateNote>,
  ) {
